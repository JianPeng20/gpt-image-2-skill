...
# ///
"""
gpt-image generate — text-to-image generation using gpt-image-2.

Run with: uv run generate.py --prompt "..." [options]

Options:
    --prompt TEXT               Required. The image generation prompt.
    --output PATH               Output file path. Default: output.<format>
    --size WxH|auto             Image size. Default: 1024x1024
    ...
    --n INT                     Number of variants to generate (1-4). Default: 1
...
def main():
    ...
    parser.add_argument("--size", default="1024x1024", help="Image size WxH or 'auto' (default: 1024x1024)")
